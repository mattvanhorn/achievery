defmodule AchieveryWeb.UserAuthTest do
  use AchieveryWeb.ConnCase, async: true

  alias Achievery.Accounts
  alias AchieveryWeb.UserAuth
  import Achievery.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AchieveryWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AchieveryWeb.Endpoint.subscribe(live_socket_id)
